...
@test "Error on set-object'ing array" {
	...
	run bobject set-object --ref OBJECT '.my_key' obj
...
@test "Error on set-object'ing array in array" {
	...
	run bobject set-object --ref OBJECT '.["my_key"].[2]' obj
...
@test "Error on set-array'ing object inside object" {
	...
	run bobject set-array --ref OBJECT '.my_key.nested' arr
...
@test "Error on set-array'ing object in array" {
	...
	run bobject set-array --ref OBJECT '.["my_key"].[2]' arr
...
@test "Error on set-string'ing array" {
	...
	run bobject set-string --ref OBJECT '.my_key' str
...
@test "Error on set-string'ing array in array" {
	...
	run bobject set-string --ref OBJECT '.["my_key"].[2]' str
